/************************ dSPACE target specific file *************************
   ...
   Include file .\base_rti1005\base_th.c :

   Task Configuration file for model : base

   RTI1005 6.3 (25-Jun-2009)/1.4
   13-Feb-2018 22:42:09
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\base_rti1005\base_th.c is for ST).
# endif
