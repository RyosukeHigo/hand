...
#
#  $RCSfile: base.mk $ $Revision: 2.36.1.1 $ $Date: 2009/02/23 16:40:51GMT+01:00 $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Distribution/MATLAB/RTI1005/M/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 120
# =============================================================================
...
MATLAB_ROOT                    = C:\MATLAB\R2008b
MATLAB_BIN                     = C:\MATLAB\R2008b\bin
MATLAB_ROOT_ALT                = C:\MATLAB\R2008b
MATLAB_BIN_ALT                 = C:\MATLAB\R2008b\bin
...
S_FUNCTIONS                    = cpvStart.c TaskSet.c ds4504_read_uint32_array.c dsa_dsdecode32.c hand02Traj.c hand02JntAngLimit.c hand02Enc2JntAng.c hand02Ctrl.c hand02JntTrq2DA.c hand02DALimit.c ds4504_DS100xAlive.c SystemSet.c ds4504_init.c
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
TID01EQ                        = 1
...
RTWCUST_INCLUDES = \
	C:\PROGRA~1\MATLAB\R2012a\work\higo\JANKEN~1\app\hand\BASE_R~1 \
	C:\PROGRA~1\MATLAB\R2012a\work\higo\JANKEN~1\app\hand
...
TMP_PATH_CC += $(MATLAB_ROOT)\rtw\c\src
TMP_PATH_CC += C:\dSPACE\MATLAB\RTI1005\SFcn
...
link_program :
	%echo $(LK_OBJS) >> $(TMP_LK)
	%ifndef LNK_OPTS
	  %set LNK_OPTS =  -QmsA0314 -QmeA0307
	%endif
